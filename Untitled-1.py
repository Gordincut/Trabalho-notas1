...
for i in range(1,quantidade_trimestre +1):
    nota = float(input(f"informe a nota do {i}º periodo: "))
    soma_notas += nota
...
if soma_notas >= meta_aprovação:
    ...
    print("Status: Reprovado!! Burro!!!")
    print(f"Faltaram {pontos_faltantes}pontos para atingir o minino de{meta_aprovação}")